...
package  {
	...
	public class child_child2 extends MovieClip {
		
		
		public function child_child2() {
			// constructor code
			trace("constructor", this, "parent:", this.parent, "parent.parent:", this.parent.parent, "name:", this.name);
