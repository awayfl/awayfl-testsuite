...
class NumberStepperIntern extends React.Component<ISWFTestProps, {}> {
...
export const NumberStepper = connect(mapStateToProps, mapDispatchToProps)(NumberStepperIntern);
